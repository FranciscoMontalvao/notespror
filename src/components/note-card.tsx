...
export const NoteCard = ({ note, onNoteDeleted }: NoteCardProps) => {
  return (
    <Dialog.Root>
      <Dialog.Trigger className='rounded-md text-left flex-col  bg-slate-800 outline-none p-5 gap-7 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="overflow-hidden inset-0 md:inset-auto fixed md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none">
            ...
            <button
              className="w-full bg-slate-800 text-sm text-slate-300 py-4 text-center outline-none font-medium group"
              type="button"
